...
import ButtonPopupChat from "./components/button-popup-chat";
...
const VerticalLayout = (props) => {
  ...
  const timeout = 1 * 3600 * 1000
  useIdleTimer({timeout, onIdle : () => handleLogout()})
                  ...
                  <BroadcastProvider>
                    <TrophyProvider>
                      ...
                      >
                        ...
                        <footer
                          className={classnames(
                            `footer footer-light ${footerClasses[footerType] || ""}`,
                            {
