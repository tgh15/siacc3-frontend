            ...
            <Card className="card-detail">
                <CardBody className="px-1">
                    ...
                    {dataDetail && <Row className="mt-2 d-flex justify-content-around">
                        <Col>
                            {
                                getRoleByMenuStatus('Performance', 'point_reduction') && localStorage.getItem('role') === 'Admin' || localStorage.getItem('role') === 'Verifikator Pusat' || localStorage.getItem('role') === 'Pimpinan Pusat'? 
