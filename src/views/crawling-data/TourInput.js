...
const steps = [
    {
        id          : 'keywords',
        title       : 'Kata Kunci',
        text        : 'Klik dan masukkan kata kunci yang ingin dicari',
    ...
    },
    {
        id          : 'amount-data',
        title       : 'Jumlah Data',
        text        : 'Klik dan masukkan jumlah data',
        attachTo    : { element: '#amount-data', on: 'bottom' },
        cancelIcon  : {
            enabled : true
        },
        buttons: [
...
const StartTour = () => {
    ...
    return (
        <Fragment>
            <div style={{cursor: 'pointer', float: 'right', margin: '0px 20px 45px 0px'}}>
                <p 
                    id      = 'positionLeft' 
            ...
            <UncontrolledTooltip 
                ...
                placement   = 'left' 
            >
                Silahkan klik untuk melihat cara penggunaan proses pengisian data
            </UncontrolledTooltip>
        </Fragment>
    );
};
